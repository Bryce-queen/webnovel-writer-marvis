# Marvis 适配说明：原版路径 `.claude/scripts` 在 Marvis 中对应 `scripts/`
# PYTHONPATH 应为 "." 或 "scripts"，测试路径应为 "scripts/data_modules/tests/..."
# 本脚本保留 Claude Code 原版路径作参考，Marvis 用户请使用 run_tests_marvis.ps1
