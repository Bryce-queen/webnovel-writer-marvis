...
长篇网文创作插件的 Marvis / Claude Code 安装包。完整介绍、安装方式与文档导航见仓库根目录的 [README](../README.md)。
...
| `/webnovel-doctor` | 诊断项目健康状态，检查文件/配置/RAG/依赖 |
...
> clean-room 安装验证建议用 `git archive` 或干净克隆，避免把本地 `node_modules/`、`__pycache__/`、`.coverage` 等开发产物带进测试环境。
